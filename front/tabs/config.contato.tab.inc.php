<?php
/**
 * Nextools - Aba Contato
 *
 * Renderiza a aba Contato da configuração (formulário, variáveis do contexto).
 *
   ...
   <div class="card shadow-sm nextool-tab-card">
      <div class="card-header mb-3 pt-2 border-top rounded-0">
         <h4 class="card-title ms-5 mb-0">
            ...
            <span>Fale com o time Nextools</span>
         </h4>
      </div>
      <div class="card-body">
               ...
               <div class="col-12">
                  <div class="form-check">
                     ...
                     <label class="form-check-label" for="contact-consent">
                        Autorizo o Nextools a entrar em contato com meus dados.
                     </label>
                  </div>
               </div>
            </div>
